...
var scarfy: Texture2D = loadTexture("assets/anim/out_width.png")

##  Texture loading
var position: Vector2 = (350.0, 280.0)

var nb_frame = 8
var sprite_size = scarfy.width div nb_frame

echo(&"{scarfy.width}x{scarfy.height}")
var frameRec: Rectangle = (0.0, 0.0, (float)(sprite_size),(float)(scarfy.height))
var currentFrame = 0
var framesCounter = 0
var framesSpeed = 8
...
while not windowShouldClose(): ##  Detect window close button or ESC key
    ...
    if framesCounter >= (60 div framesSpeed):
        ...
        if currentFrame >= nb_frame:
            currentFrame = 0
        frameRec.x = (currentFrame * (sprite_size)).float
    ...
    beginDrawing:
        ...
        drawRectangleLines(15 + frameRec.x.int, 40 + frameRec.y.int, frameRec.width.int, frameRec.height.int, Red)
